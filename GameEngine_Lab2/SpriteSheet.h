...
public:
	...
	void SetSize(short _rows, short _columns, short _clipSizeX, short _clipSizeY);
	void AddAnimation(AnimationNames _names, short _clipStart, short _clipCount, float _clipSpeed);
